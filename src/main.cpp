...
int main(int, char**) {
    ...
    // Setup Dear ImGui style with a pleasant, modern color scheme
    ...
    // Custom color scheme - soft blue/purple theme
    ImVec4* colors = style.Colors;
    colors[ImGuiCol_WindowBg] = ImVec4(0.11f, 0.12f, 0.16f, 1.00f);
    colors[ImGuiCol_ChildBg] = ImVec4(0.13f, 0.14f, 0.19f, 1.00f);
    colors[ImGuiCol_PopupBg] = ImVec4(0.14f, 0.15f, 0.20f, 0.95f);
    colors[ImGuiCol_Border] = ImVec4(0.28f, 0.32f, 0.45f, 0.50f);
    colors[ImGuiCol_FrameBg] = ImVec4(0.18f, 0.20f, 0.28f, 1.00f);
    colors[ImGuiCol_FrameBgHovered] = ImVec4(0.24f, 0.27f, 0.38f, 1.00f);
    colors[ImGuiCol_FrameBgActive] = ImVec4(0.30f, 0.34f, 0.48f, 1.00f);
    colors[ImGuiCol_TitleBg] = ImVec4(0.11f, 0.12f, 0.16f, 1.00f);
    colors[ImGuiCol_TitleBgActive] = ImVec4(0.15f, 0.17f, 0.24f, 1.00f);
    colors[ImGuiCol_MenuBarBg] = ImVec4(0.14f, 0.15f, 0.20f, 1.00f);
    colors[ImGuiCol_ScrollbarBg] = ImVec4(0.11f, 0.12f, 0.16f, 0.60f);
    colors[ImGuiCol_ScrollbarGrab] = ImVec4(0.35f, 0.40f, 0.55f, 1.00f);
    colors[ImGuiCol_ScrollbarGrabHovered] = ImVec4(0.45f, 0.50f, 0.68f, 1.00f);
    colors[ImGuiCol_ScrollbarGrabActive] = ImVec4(0.55f, 0.60f, 0.78f, 1.00f);
    colors[ImGuiCol_CheckMark] = ImVec4(0.50f, 0.70f, 0.90f, 1.00f);
    colors[ImGuiCol_SliderGrab] = ImVec4(0.45f, 0.55f, 0.80f, 1.00f);
    colors[ImGuiCol_SliderGrabActive] = ImVec4(0.55f, 0.65f, 0.92f, 1.00f);
    colors[ImGuiCol_Button] = ImVec4(0.30f, 0.38f, 0.55f, 1.00f);
    colors[ImGuiCol_ButtonHovered] = ImVec4(0.40f, 0.48f, 0.68f, 1.00f);
    colors[ImGuiCol_ButtonActive] = ImVec4(0.50f, 0.58f, 0.78f, 1.00f);
    colors[ImGuiCol_Header] = ImVec4(0.30f, 0.38f, 0.55f, 0.80f);
    colors[ImGuiCol_HeaderHovered] = ImVec4(0.40f, 0.48f, 0.68f, 0.90f);
    colors[ImGuiCol_HeaderActive] = ImVec4(0.50f, 0.58f, 0.78f, 1.00f);
    colors[ImGuiCol_Separator] = ImVec4(0.28f, 0.32f, 0.45f, 0.60f);
    colors[ImGuiCol_SeparatorHovered] = ImVec4(0.40f, 0.48f, 0.68f, 0.80f);
    colors[ImGuiCol_SeparatorActive] = ImVec4(0.50f, 0.58f, 0.78f, 1.00f);
    colors[ImGuiCol_ResizeGrip] = ImVec4(0.35f, 0.40f, 0.55f, 0.50f);
    colors[ImGuiCol_ResizeGripHovered] = ImVec4(0.45f, 0.50f, 0.68f, 0.70f);
    colors[ImGuiCol_ResizeGripActive] = ImVec4(0.55f, 0.60f, 0.78f, 0.90f);
    colors[ImGuiCol_Tab] = ImVec4(0.22f, 0.25f, 0.35f, 1.00f);
    colors[ImGuiCol_TabHovered] = ImVec4(0.40f, 0.48f, 0.68f, 1.00f);
    colors[ImGuiCol_TabActive] = ImVec4(0.35f, 0.42f, 0.60f, 1.00f);
    ...
    colors[ImGuiCol_PlotLinesHovered] = ImVec4(0.65f, 0.80f, 0.95f, 1.00f);
    colors[ImGuiCol_PlotHistogram] = ImVec4(0.50f, 0.70f, 0.90f, 1.00f);
    colors[ImGuiCol_PlotHistogramHovered] = ImVec4(0.65f, 0.80f, 0.95f, 1.00f);
